...
%>
<% 	
	String merchant_key="sIbHCVl2";
	String salt="GTgSsJ9ga4";
	String action1 ="";
	String base_url=" https://sandboxsecure.payu.in/_payment";
	int error=0;
	String hashString="";
...
<input type="hidden" name="key" value="<%= merchant_key %>" />
      ...
      <table>
        ...
        <tr>
          <td>Success URI: </td>
          <td colspan="3"><input name="surl" value="http://localhost:6018/StockTracker/RequestHandlerServlet?status=success&orderId=<%=params.get("orderId")%>" size="64" /></td>
        </tr>
        <tr>
          <td>Failure URI: </td>
          <td colspan="3"><input name="furl" value="http://localhost:6018/StockTracker/RequestHandlerServlet?status=cancel" size="64" /></td>
        </tr>
        <tr>
