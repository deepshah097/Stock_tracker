                        ...
                        <div class="wrapper-page">
                            ...
                            <div class="row m-t-30">
                                <div class="col-sm-12 text-center">
                                    <p class="text-muted">Return to <a href="Login.jsp" class="text-primary m-l-5 m-r-5"><b>Log In</b></a> OR <a href="index.html" class="text-primary m-l-5"><b>Homepage</b></a></p>
                                </div>
                            </div>
...
<!-- Mirrored from coderthemes.com/zircos_1.6/default/page-logout.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Feb 2017 04:04:40 GMT -->
</html>