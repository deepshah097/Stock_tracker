...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/23-04-2018/attainment-demo_Free/201774007/web/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Jun 2018 09:53:00 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
	<title>Storage Space Tracker-warehouse</title>
	<!-- for-mobile-apps -->
...
user_tag_config['ebound_header_tag']['mobile']['adsCode'] = '';
	...
	<section class="welcome py-5">
		<div class="container py-md-4 mt-md-3">
			<h3 class="heading-agileinfo">Ship Manager<span></span></h3>
			<div class="row about-tp mt-md-5 pt-5">
				<div class="col-lg-6 welcome-left">
					<!-- <h3>Welcom</h3> -->
					<h4>Ship manager is take the items from the warehouse and the send to the customer.He stored all details about the customer's order.Ship manager is the mediater between the warehouse and customer.Ship manager is reach the product to the customer at the given time.</h4>
				...
				<div class="col-lg-6 welcome-right">
					<div class="welcome-right-top">
						<img src="images/ab.jpg" alt="" class="img-fluid" style="height: 400px; width: 600px;">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container py-md-4 mt-md-3">
			<div class="row prepare_top">
				<div class="col-lg-7 prepare_top_right">
					<h5 class="mb-3">USES OF THE STORAGE SPACE TRACKER</h5>
					<h4>WE PREPARE THE STUDENTS FOR EXAMS AND TESTING</h4>
					<h2><p class="mt-3 mb-3">Storage Space Tracker is a dynamic web application which promises to provide the best items in town to its customers at a reasonable price. The system provides online items ordering to it's customers.We are deliver the item to customer's home.Also you should order the bulk of item from the warehouse.The system will be always updated with latest items  so the customer can easily have a benefit of them at their doorsteps. </p></h2>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-4 footer-grids">
					...
					<p class="phone">Mail:
						<a href="mailto:info@example.com">sst@gmail.com</a>
					</p>
				</div>
				<!-- <div class="col-lg-4 footer-grids">
					<h2>Latest News</h2>
...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/23-04-2018/attainment-demo_Free/201774007/web/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Jun 2018 09:53:01 GMT -->
</html>