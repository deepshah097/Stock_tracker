...
<form action="stateUpdate" name="stateUpdate" id="stateUpdate">
<input type="hidden" name="stateId" id="stateId" value="${state.stateId}">
...
<%
	...
	StateBean state=(StateBean)request.getAttribute("state");
	
	for(int i=0;i<listOfCountry.size();i++)
	{
		CountryBean country=listOfCountry.get(i);
		
		if(country.getCountryId().equals(state.getCountryId()))
		{  
%>
